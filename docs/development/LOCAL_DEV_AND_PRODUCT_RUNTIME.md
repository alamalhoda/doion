...
- استقرار فعلی از سورس با CLI چابکان در [`PRODUCTION_CHABOKAN_DEPLOY.md`](./PRODUCTION_CHABOKAN_DEPLOY.md) است؛ انتشار ایمیج تگ‌شده و CD تأییدشده گام‌های بعدی همان ویژگی CI/CD است و بدون تأیید مالک روی سرور زنده نمی‌رود
