...
| `active-frontend-toolchain.mdc` | UI فعال (`checkyar-googleai`): Bun SSOT، `bun.lock`، بدون `package-lock.json`، یادآوری one-way AI Studio | docs وضعیت فرانت + `frontend-legacy/**` | false |
